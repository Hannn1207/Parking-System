...
import { ParkingSpot, Booking, FloorId, FilterCriteria, VehicleType, SpotStatus } from './types/parking';
import {
  getStoredSpots,
  saveStoredSpots,
  getStoredBookings,
...
import { calculateTimeRemaining, formatRupiah, getVehicleTypeName } from './utils/formatters';
...
export const App: React.FC = () => {
  const [spots, setSpots] = useState<ParkingSpot[]>(getStoredSpots);
  ...
  const [theme, setTheme] = useState<'light' | 'dark'>(() => {
    return (localStorage.getItem('parkir_vision_theme') as 'light' | 'dark') || 'light';
  });
